...
import 'package:ujianpcs/register.dart';
...
class _MyHomePageState extends State<MyHomePage> {
 ...
 String username = '';
  ...
  Future login() async {
    var url = Uri.http("192.168.3.186", '/billy/ujianpcs/login/login.php', {'q': '{http}'});
    ...
    if (data.toString() == "Success") {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => DashBoard_login(username: username,),
        ),
      );
    } else {
      Fluttertoast.showToast(
